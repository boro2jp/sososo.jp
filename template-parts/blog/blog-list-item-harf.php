<article class="blog-list-item-harf">
    <a href="<?php the_permalink();?>">
        ...
        <div class="blog-list-item-harf__text">
            ...
            <div class="blog-list-item-harf__detail">
                <ul class="tag-list">
		            ...
		            foreach ($categories as $category) {
			            echo '<li class="tag-list-item small border"><span>' . $category->name . '</span></li>&nbsp;';
		            }
		            ?>
                </ul>
            ...
            <!-- <span class="blog-list-item-harf__author">
                <div
                    class="blog-list-item-harf__author-image"
                    style="background: url(<?php echo get_avatar_url($post->post_author, 300) ?>); background-size: cover; background-position: center"
                >
                </div>
                <span class="blog-list-item-harf__author-name"><?php the_author(); ?></span>
            </span> -->
        </div>
    </a>
</article>
